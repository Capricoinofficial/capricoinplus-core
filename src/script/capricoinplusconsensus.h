...
#ifndef CAPRICOINPLUS_SCRIPT_CAPRICOINPLUSCONSENSUS_H
#define CAPRICOINPLUS_SCRIPT_CAPRICOINPLUSCONSENSUS_H
...
#include <config/bitcoin-config.h>
  ...
  #endif
#elif defined(MSC_VER) && !defined(STATIC_LIBCAPRICOINPLUSCONSENSUS)
...
#endif // CAPRICOINPLUS_SCRIPT_CAPRICOINPLUSCONSENSUS_H
