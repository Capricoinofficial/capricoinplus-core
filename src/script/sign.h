...
public:
    ...
    virtual bool IsCapricoinPlusVersion() const { return false; }
...
public:
    ...
    bool IsCapricoinPlusVersion() const override { return txTo && txTo->IsCapricoinPlusVersion(); }
...
extern const BaseSignatureCreator& DUMMY_SIGNATURE_CREATOR_CAPRICOINPLUS;
