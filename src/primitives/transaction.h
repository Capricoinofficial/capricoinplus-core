...
static const uint8_t CAPRICOINPLUS_BLOCK_VERSION = 0xA0;
static const uint8_t CAPRICOINPLUS_TXN_VERSION = 0xA0;
static const uint8_t MAX_CAPRICOINPLUS_TXN_VERSION = 0xBF;
...
inline bool IsCapricoinPlusTxVersion(int nVersion)
{
    return (nVersion & 0xFF) >= CAPRICOINPLUS_TXN_VERSION;
}
...
inline void UnserializeTransaction(TxType& tx, Stream& s) {
    ...
    if (bv >= CAPRICOINPLUS_TXN_VERSION) {
        tx.nVersion = bv;
...
inline void SerializeTransaction(const TxType& tx, Stream& s) {
    ...
    if (IsCapricoinPlusTxVersion(tx.nVersion)) {
...
public:
    ...
    static const int32_t CURRENT_CAPRICOINPLUS_VERSION=0xA0;
    ...
    static const int32_t MAX_STANDARD_CAPRICOINPLUS_VERSION=0xA0;
...
public:
    ...
    bool IsCapricoinPlusVersion() const {
        return IsCapricoinPlusTxVersion(nVersion);
    }
    ...
    {
        return IsCapricoinPlusTxVersion(nVersion) ? vpout.size() : vout.size();
    }
