...
#ifndef CAPRICOINPLUS_WALLET_TEST_HDWALLET_TEST_FIXTURE_H
#define CAPRICOINPLUS_WALLET_TEST_HDWALLET_TEST_FIXTURE_H
...
#endif // CAPRICOINPLUS_WALLET_TEST_HDWALLET_TEST_FIXTURE_H
