// Copyright (c) 2017-2018 The Capricoin+ Core developers
...
BOOST_AUTO_TEST_CASE(test_TxOutRingCT)
{
    ...
    tx.nVersion = 2|CAPRICOINPLUS_TXN_VERSION;
    BOOST_CHECK_MESSAGE(tx.IsCapricoinPlusVersion(), "failed IsCapricoinPlusVersion");
